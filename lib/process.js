...
const execute = (logger, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    const config = yield misc_1.getConfigFilenames().reduce((prev, name) => __awaiter(void 0, void 0, void 0, function* () {
        const acc = yield prev;
        const config = yield github_action_config_helper_1.getConfig(name, octokit, context, { configPath: misc_1.getRelativePath(), ref: misc_1.getRef() });
        if (false === config) {
            if (!misc_1.isIgnoreWarning()) {
